...
pug_html = pug_html + "\u003Csection" + (pug.attr("id", gridId, true, false)) + "\u003E\u003C\u002Fsection\u003E";
;pug_debug_line = 10;
pug_html = pug_html + "\u003Cfooter\u003E\u003C\u002Ffooter\u003E\u003C\u002Fdiv\u003E";}.call(this,"gridId" in locals_for_with?locals_for_with.gridId:typeof gridId!=="undefined"?gridId:undefined,"name" in locals_for_with?locals_for_with.name:typeof name!=="undefined"?name:undefined,"total" in locals_for_with?locals_for_with.total:typeof total!=="undefined"?total:undefined));} catch (err) {pug.rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;},'ch-tippy-cell-data': function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;pug_debug_line = 1;
...
;pug_debug_line = 2;
pug_html = pug_html + "\u003Cdiv" + (" class=\"ch-abs-full\""+pug.attr("id", id, true, false)) + "\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"id" in locals_for_with?locals_for_with.id:typeof id!=="undefined"?id:undefined));} catch (err) {pug.rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;},'toolbar': function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;var locals_for_with = (locals || {});(function (dnPer, total, upPer) {;pug_debug_line = 1;
